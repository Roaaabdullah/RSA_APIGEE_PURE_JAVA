...
// return getHeaders().entrySet().stream().map(e ->
// e.getKey()).collect(Collectors.toSet());
// }

// public Set<String> getQueryParamNames() {
// return getQparams().entrySet().stream().map(e ->
// e.getKey()).collect(Collectors.toSet());
// }
...
// public boolean setHeaderWithMultipleValues(String name, Collection<String>
// values) {
// throw new UnsupportedOperationException();
// }
...
// public AsyncContent setAsyncContent(ExecutionContext ectx, MessageContext
// mctx) {
// throw new UnsupportedOperationException();
// }
...
// public void setQueryParamWithMultipleValues(String name, Collection<String>
// values) {
// throw new UnsupportedOperationException();
// }
