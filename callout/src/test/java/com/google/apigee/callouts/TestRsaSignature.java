...
// Object output =
// msgCtxt.getVariable(action.equals("sign") ? "signing_output" :
// "signing_verified");
...
// msgCtxt.setVariable("message.content", "The quick brown fox jumped over the
// lazy dog.");
...
// msgCtxt.getVariable("signing_output-publickey-pem");
// Assert.assertNotNull(encodedPublicKey);
// String encodedPrivateKey =
// msgCtxt.getVariable("signing_output-privatekey-pem");
...
// @Test(dataProvider = "pss-signature-encodings")
// public void verify_RSASSA_PSS_ProvidedKey(String encodedSignature, String
// encoding) {
// Map<String, String> properties = new HashMap<String, String>();
...
// @Test(dataProvider = "pss-signature-encodings")
// public void verify_PSS_ProvidedKey_Wrong_Hash(String encodedSignature, String
// encoding) {
// Map<String, String> properties = new HashMap<String, String>();
